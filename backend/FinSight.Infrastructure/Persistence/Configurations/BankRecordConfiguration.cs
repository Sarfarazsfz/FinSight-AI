...
public class BankRecordConfiguration
    : IEntityTypeConfiguration<BankRecord>
{
    public void Configure(
        EntityTypeBuilder<BankRecord> builder)
    {
        builder.ToTable("bank_records");
        ...
        .HasDatabaseName(
            "IX_Bank_Batch_TransactionReference");
