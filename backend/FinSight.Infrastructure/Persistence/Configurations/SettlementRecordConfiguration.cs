...
public class SettlementRecordConfiguration
    : IEntityTypeConfiguration<SettlementRecord>
{
    public void Configure(
        EntityTypeBuilder<SettlementRecord> builder)
    {
        ...
        .HasDatabaseName(
            "IX_Settlement_Batch_TransactionReference");
